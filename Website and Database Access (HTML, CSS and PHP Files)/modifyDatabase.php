...
if($_POST[password] == $password){
    ...
    $dataToEdit = $_POST[dataNamesDropDown];
    $name = $_POST[name];
    ...
    /*$sql = "UPDATE DB_Information "."(Name, Location, DataType, Units, WebID, ID, Status, XCoordinates, YCoordinates) "."VALUES ('$name', '$location', '$dataType', '$units', '$webID', '$ID', '$status', '$latitude', '$longitude')"."WHERE NAME = $_POST[dataNames]";*/

    $sql = "UPDATE DB_Information SET Name='$name', Location='$location', DataType='$dataType', Units='$units', WebID='$webID', ID='$ID', Status='$status', XCoordinates='$latitude', YCoordinates='$longitude' WHERE Name ='$dataToEdit'";
